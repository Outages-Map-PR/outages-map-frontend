          ...
          <ul className={!nav ? "nav-item active" : "nav-item hidden"}>
            <li className="mobile-item">
              <Link to="/" className="nav-links-mobile">
                <span>
                  <HiOutlineHome className="icon-mobile" size="25px" /> Home{" "}
                </span>
              </Link>
            </li>
            <li className="mobile-item">
              <Link to="/recent-reports" className="nav-links-mobile">
                <span>
                  <TbReportAnalytics className="icon-mobile" size="25px" />{" "}
                  Recent Reports
                </span>
              </Link>
            </li>
            <li className="mobile-item">
              <Link to="/historical-data" className="nav-links-mobile">
                <span>
                  <HiOutlineFolderOpen className="icon-mobile" size="25px" />{" "}
                  Historical Data
                </span>
              </Link>
            </li>
